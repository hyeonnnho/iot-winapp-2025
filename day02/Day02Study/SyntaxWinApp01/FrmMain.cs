namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        {
            MessageBox.Show("첫번째 메시지", "알림", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            System.UInt16 usstVal2 = System.UInt16.MinValue; // 0 할당
            ...
            // Nullable
            //int int02 = null;   // 기본타입(정수형, 실수형, 불린 / 문자열제외)은 NULL 할당 불가
            ...
            // 동적 타입 // 컴파일되면서 해당 타입으로 형 결정
            var int05 = "50";
            //int05 = false;

            //MessageBox.Show(intVal2.ToString(), "Variable", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            MessageBox.Show(str02, "Variable", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }

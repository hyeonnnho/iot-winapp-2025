...
- `TextBox` : 텍스트 입력을 위한 컨트롤
    ...
    - PasswordChar : 들어가는 텍스트를 암호처럼 숨길 때 사용. 보통 ㅁ한자 키 특수문자 를 사용
...
- `ColorDialog` : 색상을 선태갛는 다이얼로그 컨트롤
    - 보통 DlgColor 이름으로 사용
...
- WPF 컴포넌트(실무에서 쓰이는 UI컴포넌트) : Thrid Party
...
- 데이터바인딩 : [디자인](./day07/Day07Study/WpfStudyApp04/MainWindow.xaml) [소스](./day07/Day07Study/WpfStudyApp04/MainWindow.xaml.cs)
    ...
    - ItemSource : 각 컨트롤이 데이터를 바인딩하는 속성
...
- 컨트롤 디자인, 리소스  : [소스](./day08/Day08Study/WpfStudyApp04/MainWindow.xaml)
    ...
    - 리소스 : 컨트롤의 공유화
        - App.xamlApplication.Resources 에 필요한 컨트롤 디자인을 정의
...
- 공식 사이트 : https://mahapps.com/
    - 최소한의 노력으로 Metro UI/Modern UI를 적용시킬 수 있는 프레임워크
...
- 사용법 : [소스](./day08/Day08Study/WpfStudyApp05/MainWindow.xaml)
    ...
    2. https://github.com/MahApps/MahApps.Metro/releases/tag/2.4.10
...
### MahApps.Metro 프레임워크
- 컨트롤 사용법 : [소스](./day09/Day09Study/WpfStudyApp02/MainWindow.xaml)
...
- 기본 사용법 : [소스](./day09/Day09Study/WpfStudyApp07/MainWindow.xaml)
    ...
    - Grid 내 타이틀바 추가
        ...
        ```
    - Theme를 Dark로 했을 경우
        - Window 전체 Background를 어두운 색으로 지정후 확인
    - 실행결과
...
- 무엇을 만들까 고민을 하다가 요즘에 정보처리기사를 공부하느라 기출문제를 풀고 있어서 시험 프로그램을 만들어 보았습니다.
    1. 시작화면
        <img src="./toyproject/Image/tp01.png" width="600">
    2. 예외처리
        - 기초 인적 사항, 수험생 정보 반드시 입력
        - 시험 과목 중 정보처리기사만 가능
        <img src="./toyproject/Image/tp02.png" width="600">
        <img src="./toyproject/Image/tp03.png" width="600">
        <img src="./toyproject/Image/tp04.png" width="600">
        <img src="./toyproject/Image/tp05.png" width="600">
        <img src="./toyproject/Image/tp06.png" width="600">
    3. 시험 시작
        - 확인 누르면 대기화면에서 문제로 넘어가며 타이머 시작 
        <img src="./toyproject/Image/tp07.png" width="600">
    4. 시험 종료
        - 준비된 문제가 끝나면 총 문제 중 몇개 맞추었는지 알려주는 메시지
        <img src="./toyproject/Image/tp08.png" width="600">
        - 결과를 txt파일로 저장 가능
        <img src="./toyproject/Image/tp09.png" width="600">
        - 시험결과 txt
        <img src="./toyproject/Image/tp11.png" width="600">


- 📚 출처  
    - 한국산업인력공단 큐넷 (https://www.q-net.or.kr)
    - 정보처리기사 기출문제 캡처 및 정리 (학습 목적 활용)
